        ...
        child: ListView(
          ...
          children: [
            ...
            ..._shadingTypes(_currentColorType).map((Map<Color, String> color) {
              final Color firstColor = color.keys.first;
              return GestureDetector(
                onTap: () {
                  setState(() => _currentShading = firstColor);
                  widget.onColorChanged(firstColor);
                },
                child: Container(
                  color: const Color(0x00000000),
                  margin: isPortrait
                  ...
                  child: Align(
                    child: AnimatedContainer(
                      ...
                      width: isPortrait
                          ? (_currentShading == firstColor ? 250 : 230)
                          : (_currentShading == firstColor ? 50 : 30),
                      height: isPortrait ? 50 : 220,
                      decoration: BoxDecoration(
                        color: firstColor,
                        boxShadow: _currentShading == firstColor
                            ? [
                            ...
                            : null,
                        border: (firstColor == Colors.white) ||
                                (firstColor == Colors.black)
                            ? Border.all(
                                color: (Theme.of(context).brightness ==
                                        Brightness.light)
                      ...
                      child: widget.enableLabel
                          ? isPortrait
                              ? Row(
                                  children: [
                                    Text(
                                      '  ${color.values.first}',
                                      style: TextStyle(
                                          color: useWhiteForeground(firstColor)
                                              ? Colors.white
                                              : Colors.black),
                                    ),
                                    Expanded(
                                      child: Align(
                                        ...
                                        child: Text(
                                          '#${(firstColor.toString().replaceFirst('Color(0xff', '').replaceFirst(')', '')).toUpperCase()}  ',
                                          style: TextStyle(
                                            color:
                                                useWhiteForeground(firstColor)
                                                    ? Colors.white
                                                    : Colors.black,
                              ...
                              : AnimatedOpacity(
                                  duration: const Duration(milliseconds: 300),
                                  opacity:
                                      _currentShading == firstColor ? 1 : 0,
                                  child: Container(
